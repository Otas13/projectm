...
let testResultSchema = new mongoose.Schema({
    ...
    layoutFive: { scenarioOne: mongoose.Schema.Types.Mixed, scenarioTwo: mongoose.Schema.Types.Mixed, scenarioThree: mongoose.Schema.Types.Mixed, scenarioFour: mongoose.Schema.Types.Mixed },
}, schemaOptions);
